...
export const fetchMovies = async (searchTitle?: string, lowerSearchYear?: string, upperSearchYear?: string, searchGenre?: string[], userResultLimit?: string, sampleResultLimit?: string, tableSelection?: string) => {
