    ...
    <main className="container mb-16">
        ...
        <div className="grid grid-cols-3 gap-4">
          <form className="border border-foreground p-4 flex flex-col gap-2" onSubmit={handleSubmit}>
            ...
            <div className="border border-foreground p-4 flex flex-col gap-2">
              <span className="text-lg">search movies</span>
              <input
      ...
      <section className="mt-16">
        <div className="flex flex-col">
          <p className="grid grid-cols-6 border-b border-foreground">
            <span className="col-span-3">title</span>
            <span>release year</span>
            <span className="col-span-2">genres</span>
          </p>
          {movies.map((movie) => (
            <div className="grid grid-cols-6 items-center py-2 border-foreground-muted border-b" key={movie._id}>
              <h3 className="col-span-3">{movie.title}</h3>
              <p>{movie.year}</p>
              ...
              {movie.source === "user" ? (
                <button
                  ...
                  className="bg-primary hover:bg-primary-muted transition-colors"
                >
                  .delete
                </button>
              ) :
